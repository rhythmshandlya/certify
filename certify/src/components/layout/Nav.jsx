...
const Nav = () => {
  return (
    <nav className="bg-[#5158b9] border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
              ...
              return (
                <li>
                  <a
                    ...
                    className="block py-2 pr-4 pl-3 text-[18px] text-white rounded md:bg-transparent md:p-0 dark:text-white"
                  >
                    {link.name}
                  </a>
                </li>
